...
int main(int argc, char *argv[]){
    ...
    for(int i=0; i<10; i++){
        ...
        //subnet allocation to topology, left right leaf seperately and bottleneck seperately
        ...
        // Classifier for different flows in the network
    ...
    std::string plotTitleSD = "wired-topo Throughput vs PacketSize in " + tcpProtocol;
    ...
    // Plt file and Graph file for throughput vs packetsize
    std::string graphFileNameDS = tcpProtocol+"throughput_vs_packetSizeDS.png";
    ...
    std::string plotTitleJFind = "wired-topo JFind vs PacketSize in " + tcpProtocol;
